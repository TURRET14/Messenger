...
@authorization_router.post("/users", response_class=fastapi.responses.JSONResponse)
async def post_user(
    ...
    return await backend.handles.implementations.authorization.post_user(data, db)
