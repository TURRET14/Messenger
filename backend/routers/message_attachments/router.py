...
async def add_message_attachment_file(
    ...
    return await service.add_message_attachment_file(selected_chat, selected_message, file, selected_user, minio_client, db)


@message_attachments_router.post("chats/id/{chat_id}/messages/id/{message_id}/attachments/id/{attachment_id}", response_class = fastapi.responses.Response)
async def delete_message_attachment_file(
    ...
    return await service.delete_message_attachment_file(selected_chat, selected_message, selected_attachment, selected_user, minio_client, db)