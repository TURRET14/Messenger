...
async def validate_chat_message_has_comments(
    selected_chat: Chat,
...
async def validate_post_message(
    ...
    if message_reply_message_id:
        ...
        await checks.check_does_message_belong_to_chat(selected_chat, reply_message)
...
async def validate_message_receipt(
    ...
    await checks.check_is_message_already_marked_as_received_by_user(selected_message, selected_user, db)